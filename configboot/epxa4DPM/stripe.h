/* megafunction wizard: %ARM-Based Excalibur%
   ...
   PROJECT: configboot
   ============================================================
   File Name: /work_lbnl/IceCubeCVS/dom-fpga/configboot/epxa4DPM/stripe.h
...
#ifndef	CONFIGBOOT_H_INCLUDED
#define	CONFIGBOOT_H_INCLUDED

#define EXC_DEFINE_PROCESSOR_LITTLE_ENDIAN
#define EXC_DEFINE_BOOT_FROM_SERIAL

#define	EXC_INPUT_CLK_FREQUENCY (20000000)
#define	EXC_AHB1_CLK_FREQUENCY (40000000)
#define	EXC_AHB2_CLK_FREQUENCY (20000000)
...
#define	EXC_SPSRAM_BLOCK1_BASE (0x00010000)
...
#define	EXC_DPSRAM_BLOCK1_BASE (0x80008000)
