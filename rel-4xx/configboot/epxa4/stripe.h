/* megafunction wizard: %ARM-Based Excalibur%
   ...
   PROJECT: configboot
   ============================================================
   File Name: \work_lbnl\icecubecvs\dom-fpga\configboot\epxa4\stripe.h
...
#define	EXC_EBI_BLOCK3_SIZE (0x00004000)
#define	EXC_EBI_BLOCK3_WIDTH (8)
