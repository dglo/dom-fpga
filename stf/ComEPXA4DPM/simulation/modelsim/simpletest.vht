...
-- ***************************************************************************
-- Generated on "01/13/2004 09:00:51"
...
-- signals
    ...
    SIGNAL t_sig_PDL_FPGA_D           :       STD_LOGIC_VECTOR(7 DOWNTO 0);
    ...
    SIGNAL DOR_DAC : STD_LOGIC_VECTOR (7 DOWNTO 0);
    SIGNAL DOR_ADC : STD_LOGIC_VECTOR (11 DOWNTO 0);
...
-- list connections between master ports and signals
    ...
    t_sig_OneSPE   <= '0', '1' AFTER 500 ns, '0' AFTER 600 ns, '1' AFTER 5500 ns, '0' AFTER 5600 ns, '1' AFTER 150000 ns, '0' AFTER 150100 ns, '1' AFTER 200000 ns, '0' AFTER 200100 ns, '1' AFTER 300000 ns, '0' AFTER 300100 ns;
    t_sig_MultiSPE <= '0';
...
-- variable declarations
    ...
    cable_inst : cable
        PORT MAP (
            DOR_DAC => DOR_DAC,
            DOR_ADC => DOR_ADC,
            DOM_DAC => t_sig_COM_DB,
            DOM_ADC => t_sig_COM_AD_D
            );
