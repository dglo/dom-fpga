...
; PROJECT: simpletest
; ============================================================
; File Name: c:\icecube\fpgacode\hardwaretest\simpletest\stripe.s
...
EXC_AHB1_CLK_FREQUENCY EQU (10000000)
EXC_AHB2_CLK_FREQUENCY EQU (5000000)
...
EXC_EBI_BLOCK2_WIDTH EQU (16)
EXC_EBI_BLOCK2_NON_CACHEABLE EQU (1)
EXC_EBI_BLOCK2_CACHEABLE EQU (0)
EXC_EBI_BLOCK3_BASE EQU (0x60000000)
EXC_EBI_BLOCK3_SIZE EQU (0x00010000)
...
EXC_SDRAM_BLOCK0_SIZE EQU (0x00800000)
EXC_SDRAM_BLOCK0_WIDTH EQU (32)
EXC_SDRAM_BLOCK1_BASE EQU (0x00800000)
EXC_SDRAM_BLOCK1_SIZE EQU (0x00800000)
EXC_SDRAM_BLOCK1_WIDTH EQU (32)

; Single Port SRAM Block(s)
EXC_SPSRAM_BLOCK0_BASE EQU (0x10000000)
EXC_SPSRAM_BLOCK0_SIZE EQU (0x00004000)
EXC_SPSRAM_BLOCK1_BASE EQU (0x10040000)
...
EXC_DPSRAM_BLOCK0_SIZE EQU (0x00010000)
EXC_DPSRAM_BLOCK0_WIDTH EQU (8)

; PLD Block(s)
EXC_PLD_BLOCK0_BASE EQU (0x90000000)
EXC_PLD_BLOCK0_SIZE EQU (0x00100000)
